...
public class ${PROJECT_MAIN_CLASS_NAME} implements KeyListener {
    ...
    public ${PROJECT_MAIN_CLASS_NAME}() {
        info(${PROJECT_MAIN_CLASS_NAME}.class, "Create ${PROJECT_MAIN_CLASS_NAME} '%s'", getI18n("app.name", "Application"));
    }
    ...
    public void run(String[] args) {
        info(${PROJECT_MAIN_CLASS_NAME}.class, "${PROJECT_MAIN_CLASS_NAME} '%s' is running..", getI18n("app.name", "1.0.0"));
        for (String arg : args) {
    ...
    private void init(String[] args) {
        info(${PROJECT_MAIN_CLASS_NAME}.class, "${PROJECT_MAIN_CLASS_NAME} '%s' is initializing.", getI18n("app.name", "Application"));
        // default values
    ...
    private void dispose() {
        ...
        info(${PROJECT_MAIN_CLASS_NAME}.class, "${PROJECT_MAIN_CLASS_NAME} '%s' is ending.", i18Text.getString("app.name"));
